...
from shared.database.database_connection import DatabaseSessionFactory

class TestDatabaseSessionFactory:
    @pytest.fixture(scope='module')
    def db_session_factory(self):
        with patch('shared.database.database_connection.create_engine') as mock_create_engine:
    ...
    def test_database_url(self, db_session_factory):
        expected_url = "postgresql+psycopg2://portfolio_manager:portfolio_manager@postgres-api:5432/portfolio"
